...
class RecipeResourceIT {
    ...
    public static Recipe createEntity(EntityManager em) {
        Recipe recipe = new Recipe().name(DEFAULT_NAME).description(DEFAULT_DESCRIPTION);
        return recipe;
    }
    ...
    public static Recipe createUpdatedEntity(EntityManager em) {
        Recipe recipe = new Recipe().name(UPDATED_NAME).description(UPDATED_DESCRIPTION);
        return recipe;
    }
    ...
    void putNewRecipe() throws Exception {
        ...
        updatedRecipe.name(UPDATED_NAME).description(UPDATED_DESCRIPTION);
