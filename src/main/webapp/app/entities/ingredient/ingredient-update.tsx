...
export const IngredientUpdate = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="cookbookApp.ingredient.home.createOrEditLabel" data-cy="IngredientCreateUpdateHeading">
            <Translate contentKey="cookbookApp.ingredient.home.createOrEditLabel">Create or edit a Ingredient</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('cookbookApp.ingredient.name')}
                id="ingredient-name"
                name="name"
                data-cy="name"
                type="text"
