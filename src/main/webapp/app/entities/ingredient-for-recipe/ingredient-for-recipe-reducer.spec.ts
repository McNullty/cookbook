...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './ingredient-for-recipe.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_INGREDIENTFORRECIPE_LIST actions', async () => {
    ...
    it('dispatches FETCH_INGREDIENTFORRECIPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_INGREDIENTFORRECIPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_INGREDIENTFORRECIPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_INGREDIENTFORRECIPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_INGREDIENTFORRECIPE actions', async () => {
      const expectedActions = [
        {
