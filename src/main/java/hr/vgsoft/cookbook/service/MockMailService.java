...
public class MockMailService extends AbstractMailService {
	...
	public MockMailService(JHipsterProperties jHipsterProperties, JavaMailSender javaMailSender,
			MessageSource messageSource, SpringTemplateEngine templateEngine) {
		super(jHipsterProperties, messageSource, templateEngine);
		this.javaMailSender = javaMailSender;
	}

	private final Logger log = LoggerFactory.getLogger(MockMailService.class);
	...
	void sendEmail(String to, String subject, String content, boolean isMultipart, boolean isHtml) {
		...
		try {
			...
			log.debug("Writing mail to log: " + mimeMessage);
