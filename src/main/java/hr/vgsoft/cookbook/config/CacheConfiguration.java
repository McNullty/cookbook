...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, hr.vgsoft.cookbook.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, hr.vgsoft.cookbook.repository.UserRepository.USERS_BY_EMAIL_CACHE);
